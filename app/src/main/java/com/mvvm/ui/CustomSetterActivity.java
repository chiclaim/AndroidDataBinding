 ...
 */
public class CustomSetterActivity extends BaseActivity implements UserFollowEvent {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CustomSetterBinding binding = DataBindingUtil.setContentView(this,
                R.layout.activity_custom_setter);
        user = new User();
